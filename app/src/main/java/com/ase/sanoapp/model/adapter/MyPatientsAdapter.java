...
import com.ase.sanoapp.controller.ChatActivity;
import com.ase.sanoapp.controller.FolderMedical;
import com.ase.sanoapp.R;
import com.ase.sanoapp.model.Patient;
...
public class MyPatientsAdapter extends FirestoreRecyclerAdapter<Patient, MyPatientsAdapter.MyPatientsHolder> {
    ...
    private void openPatientMedicalFolder(Context medicalFolder, Patient patient){
        Intent intent = new Intent(medicalFolder, FolderMedical.class);
