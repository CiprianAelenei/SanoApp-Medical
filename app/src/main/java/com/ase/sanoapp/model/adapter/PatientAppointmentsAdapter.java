package com.ase.sanoapp.model.adapter;
...
public class PatientAppointmentsAdapter extends FirestoreRecyclerAdapter<ApointementInformation, PatientAppointmentsAdapter.PatientAppointmentsHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull PatientAppointmentsHolder patientAppointmentsHolder, int position,
                                    @NonNull final ApointementInformation apointementInformation) {
        ...
        String status = apointementInformation.getType();
        if(status.equals("Checked"))
            patientAppointmentsHolder.type.setText("Verificat");
            else
            patientAppointmentsHolder.type.setText("Acceptat");
