package com.ase.sanoapp.treatment.source.local;
...
// ############################# get methods ####################################### //
     ...
     * @throws URISyntaxException
     */
    private List<MedicineAlarm> combineAlarms(List<MedicineAlarm> dbAlarms)
            throws URISyntaxException {
...
//        String cursor = (String.valueOf(sqLiteDatabase.rawQuery("select count(*) from histories", null, null)));
        return DatabaseUtils.queryNumEntries(sqLiteDatabase, PILL_TABLE);
    }
