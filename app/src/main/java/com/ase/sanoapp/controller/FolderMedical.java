...
import com.ase.sanoapp.model.adapter.ConsultationFragmentAdapter;
...
public class FolderMedical extends AppCompatActivity {
    private final static String TAG = "FolderMedical";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate folder medical activity: started");
        getIncomingIntent();
