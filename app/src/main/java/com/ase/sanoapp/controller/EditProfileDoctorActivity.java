...
import com.ase.sanoapp.model.UploadImage;
...
public class EditProfileDoctorActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Set the default informtions in the text fields
            ...
            storageReference.putFile(uriImage).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(EditProfileDoctorActivity.this, "Incarcat fara succes: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
