...
import com.ase.sanoapp.model.adapter.MessageAdapter;
import com.ase.sanoapp.model.Message;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MessageRef1 = FirebaseFirestore.getInstance().collection("chat").
                document(extras.getString("key1")).collection("message");

        MessageRef2 = FirebaseFirestore.getInstance().collection("chat").
                document(extras.getString("key2")).collection("message");
        ...
        btnEnvoyer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Message msg = new Message(envoyer.getText().toString(),FirebaseAuth.getInstance().
