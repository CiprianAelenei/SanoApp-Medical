...
import com.ase.sanoapp.model.User;
...
//       mGoogleSignInClient = GoogleSignIn.getClient(this, gso);
        ...
        textView.setText("Conectare cu Google");
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email, password)
                    ...
                    Toast.makeText(MainActivity.this, "Trebuie completate toate campurile",
                            Toast.LENGTH_SHORT).show();
        ...
        creatBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (creatBtn.getText().toString().equals("Creeaza cont")){
                    ...
                    creatBtn.setText("Inapoi la conectare");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.w("TAG", "Autentificare Google esuata.", e);
                // ...
            }
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(findViewById(R.id.main_layout), "Autentificare esuata.", Snackbar.LENGTH_SHORT).show();
                            updateUI(null);
                        }
                    }
                });
