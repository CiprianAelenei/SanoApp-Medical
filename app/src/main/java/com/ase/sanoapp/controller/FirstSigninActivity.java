...
import com.ase.sanoapp.model.fireStoreApi.DoctorHelper;
import com.ase.sanoapp.model.fireStoreApi.PatientHelper;
import com.ase.sanoapp.model.fireStoreApi.UserHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String typePre = spinner.getSelectedItem().toString();

                if(typePre.equals("Pacient")){
                    type = "Patient";
                } else{
                    type = "Doctor";}
