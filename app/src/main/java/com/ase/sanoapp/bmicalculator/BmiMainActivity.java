    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcalculatebmi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Selectati sexul dvs",Toast.LENGTH_SHORT).show();
                }
                else if(mintprogress.equals("0"))
                {
                    Toast.makeText(getApplicationContext(),"Selectati greutatea dvs",Toast.LENGTH_SHORT).show();
                }
                else if(intage==0 || intage<0)
                {
                    Toast.makeText(getApplicationContext(),"Varsta este incorecta",Toast.LENGTH_SHORT).show();
                }

                else if(intweight==0|| intweight<0)
                {
                    Toast.makeText(getApplicationContext(),"Selectati inaltimea dvs",Toast.LENGTH_SHORT).show();
                }
                else {
